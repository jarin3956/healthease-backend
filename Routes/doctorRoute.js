...
doctor_route.post('/register', doctorController.doctorRegister);
...
doctor_route.post('/start-journey',doctorVerify,doctorController.addMoreData);
...
doctor_route.put('/edit-profile',doctorVerify ,doctorController.loadDocEdit);
